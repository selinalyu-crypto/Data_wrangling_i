...
``` r
# keep and rename only these columns
```
...
``` r
# just want to rename, keep every column
```
...
``` r
# keep everything that start with gd
```
...
``` r
# move litter number to the first, keep everything else
```
...
``` r
# do all the things that does not = 20
```
